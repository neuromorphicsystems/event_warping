...
SAVE                = 1
WEIGHT              = 1
VIDEOS              = ["res_128x128_noise_1000000_signal_0","res_128x128_noise_300000_signal_0"]
OBJECTIVE           = ["variance","weightVar"]
FILENAME            = VIDEOS[0]
...
def saveimg(contrastmap,var,fun_idx,draw=False):
    ...
    im1 = new_image.save("img/weight_map/eventmap_vy_" + str(fieldy*t)  + "_vx_" + str(fieldx*t) + "_" + "var_" + str(var) + ".jpg")
    fun_idx=0
